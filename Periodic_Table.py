...
View this code at hhtps://nostarch.com/big-book-small-python-projects
Tags: short, sceince"""

# Data from hhtps://en.wikipedia.org/wiki/List_of_chemical_elements
...
# To justify the text, we need to fing the longest string in ALL_COLUMNS.
LONGEST_COLUMN = 0
...
while True:  # Main program loop.
    ...
    # Display the selected elemt's data:
