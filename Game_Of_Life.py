...
More info at: https://en.wikipedia.org/wiki/Conway%27s_Gameof_Life
...
WIDTH = 160  # The width of the cell grid.
HEIGHT = 50  # The height of the cell grid.
...
while True:  # Main program loop.
    ...
    for x in range(WIDTH):
        for y in range(HEIGHT):
            ...
            if cells[(left, above)] == ALIVE:
                numNeighbors += 1  # Top-left nighbor is alive.
            ...
            if cells[(left, below)] == ALIVE:
                numNeighbors += 1  # Bottom=;eft neigbor is alive.
            if cells[(x, below)] == ALIVE:
                numNeighbors += 1  # Bottom neigbor is alive.
    ...
    try:
        time.sleep(0.03)  # Add a 1 second pause to reduce flickering.
